create database functions_assignment;
use functions_assignment;
...
SELECT 
    ...
    TO_CHAR(join_date, 'Month') AS join_month
FROM Student_Performance;
...
SELECT 
    name,
    join_date,
    DATE '2025-01-01' - join_date AS days_enrolled
FROM Student_Performance;
##Question 8 : Format join_date as “Month Year” (e.g., “June 2023”).
SELECT 
    name,
    TO_CHAR(join_date, 'FMMonth YYYY') AS formatted_date
FROM Student_Performance;
